...
const ProductImage = () => {
    return <div className="relative w-fit">
        ...
        <TypeBadge type="sativa" classname="absolute z-10 top-2.5 left-2.5 " />
    ...
    return <FlexColumn className="gap-l w-[250px]">
        ...
        <Flex className="gap-2.5">
            <FlexColumn className="gap-2.5">
                <Typography intent="monsNormal13" classname="w-[200px] line-clamp-2">Pod Live Rosin 0.5g - Guava dwq dwq    dwq dwq kl jklwqj dklqjw klqjw klqj lkq (T3)</Typography>
